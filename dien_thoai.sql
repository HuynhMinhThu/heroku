...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 31, 2019 lúc 08:33 AM
...
CREATE TABLE `binhluan` (
  ...
  `MaSP` varchar(50) COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `MaKH` int(11) NOT NULL,
  `NoiDung` varchar(1000) COLLATE utf8mb4_vietnamese_ci NOT NULL,
...
(2, 'IP6PLUS16', 1, 'đẹp', '2019-12-11 12:09:15');
...
--
-- Cấu trúc bảng cho bảng `chitietmausp`
--
...
--
-- Đang đổ dữ liệu cho bảng `chitietmausp`
--
...
CREATE TABLE `danhmuc` (
  ...
  `TenDM` varchar(100) COLLATE utf8mb4_vietnamese_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci;
...
(1, 'Nguyễn Nam Cường', 'Đà Nẵng', 'Cuong@gmail.com', 778923743, '123456');
...
CREATE TABLE `khuyenmai` (
  ...
  `TenKM` varchar(100) COLLATE utf8mb4_vietnamese_ci NOT NULL,
...
(1, 'Phiếu mua hàng Samsung trị giá 300.000đ', 300000, 'Phiếu mua hàng Samsung trị giá 300.000đ', '2019-12-06', '2020-01-31'),
(2, 'Ưu đãi quà tặng độc quyền Galaxy trị giá đến 450.000đ', 450000, 'Ưu đãi quà tặng độc quyền Galaxy trị giá đến 450.000đ', '2019-12-06', '2020-01-31'),
(7, 'Khuyễn mãi OPPO SƠN TÙNG MTP', 200000, 'OPPO đi cùng MTP', '2019-12-11', '2020-01-01');
...
CREATE TABLE `sanpham` (
  ...
  `AnhNen` varchar(100) COLLATE utf8mb4_vietnamese_ci NOT NULL,
...
('IPX64', 'Điện thoại iPhone X 64GB', 'iPhone X 64 GB là cụm từ được rất nhiều người mong chờ muốn biết và tìm kiếm trên Google bởi đây là chiếc điện thoại mà Apple kỉ niệm 10 năm iPhone đầu tiên được bán ra.', 'ip10.png', 1, NULL, 25990000, 100),
...
('Vivos1', 'Điện thoại Vivo S1', 'Vivo S1 là chiếc smartphone S series mới sở hữu thiết kế tuyệt đẹp, đi kèm hệ thống 3 camera sau, cùng giá bán khá hấp dẫn.', 'vivos1.png', 2, NULL, 5990000, 100),
...
CREATE TABLE `thongtinsp` (
  ...
  `HDH` varchar(100) COLLATE utf8mb4_vietnamese_ci NOT NULL,
...
('Vivos1', 'Super AMOLED, 6.38\", Full HD+', 'Android 9.0 (Pie)', 'Chính 16 MP & Phụ 8 MP, 2 MP', '32 MP', 'MediaTek MT6768 8 nhân (Helio P65)', '6 GB', '128 GB', '\r\n2 Nano SIM, Hỗ trợ 4G', '4500 mAh, có sạc nhanh'),
...
CREATE TABLE `thuonghieu` (
  `MaTH` int(11) NOT NULL,
  `TenTH` varchar(100) COLLATE utf8mb4_vietnamese_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci;
...
--
-- Các ràng buộc cho bảng `chitietmausp`
--
ALTER TABLE `chitietmausp`
